	...
	*/
	...
	Tree.prototype._renderNode = function (node, previousNode) {
        ...
        // Add def as badge tooltip
         if (this._options.showTips && node.def) {
             	node.$el.append(this._template.tip).attr('title', node.def).tooltip();
		 }
	...
	Tree.prototype._template = {
        ...
        tip : $('<span class="badge" data-toggle="tooltip" data-placement="right" data-container="body">Tip</span>'),
